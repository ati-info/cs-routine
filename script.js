document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Function to hide the light bulb with fade animation ---
    function hideLightBulb() {
        lightBulbContainer.style.opacity = '0';
        lightBulbContainer.style.pointerEvents = 'none'; // Prevents clicks
    }

    // --- Function to show the light bulb with fade animation ---
    function showLightBulb() {
        lightBulbContainer.style.opacity = '1';
        lightBulbContainer.style.pointerEvents = 'auto'; // Allows clicks
    }
    ...
    function resetInactivityTimer() {
        ...
        showLightBulb();
        inactivityTimer = setTimeout(hideLightBulb, 1000); // 1000ms = 1 second of inactivity
    }
    ...
    // Add click event for the creator text
    if (creatorText) {
    ...
    // Initial state for body background
    document.body.classList.add('light-off');
    mainContainer.classList.add('hidden');
    welcomePopup.classList.remove('hidden');

    // Initial timer reset to hide the bulb if the user is inactive from the start
